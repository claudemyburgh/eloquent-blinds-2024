...
class Container_7c2c76dceb extends _PHPStan_5473b6701\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService049(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_7c2c76dceb $container)
			{
	...
	public function createServiceContainer(): Container_7c2c76dceb
	{
		return $this;
	}
