...
class Container_b34b57ca11 extends _PHPStan_5473b6701\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService049(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_b34b57ca11 $container)
			{
	...
	public function createServiceContainer(): Container_b34b57ca11
	{
		return $this;
	}
