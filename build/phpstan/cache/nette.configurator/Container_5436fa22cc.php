...
// source: phar://C:\www\2024-clients\eloquent-blinds-2024\vendor\phpstan\phpstan\phpstan.phar/conf/config.level3.neon
...
class Container_5436fa22cc extends _PHPStan_5473b6701\Nette\DI\Container
{
	protected $tags = [
		...
		'phpstan.broker.methodsClassReflectionExtension' => ['093' => true, '097' => true, '0372' => true],
		...
		'phpstan.typeSpecifier.methodTypeSpecifyingExtension' => ['0245' => true, '0379' => true],
		'phpstan.rules.rule' => [
			'0315' => true,
			'0319' => true,
			'0320' => true,
		...
		'phpstan.deprecations.deprecatedScopeResolver' => ['0376' => true],
		'phpstan.phpDoc.typeNodeResolverExtension' => ['0377' => true],
		'phpstan.typeSpecifier.staticMethodTypeSpecifyingExtension' => ['0380' => true],
	];
	...
	protected $wiring = [
		...
		'PHPStan\Rules\Deprecations\AccessDeprecatedPropertyRule' => [['rules.149']],
		'PHPStan\Rules\Deprecations\AccessDeprecatedStaticPropertyRule' => [['rules.150']],
		'PHPStan\Rules\Deprecations\CallToDeprecatedFunctionRule' => [['rules.151']],
		'PHPStan\Rules\Deprecations\CallToDeprecatedMethodRule' => [['rules.152']],
		'PHPStan\Rules\Deprecations\CallToDeprecatedStaticMethodRule' => [['rules.153']],
		'PHPStan\Rules\Deprecations\FetchingClassConstOfDeprecatedClassRule' => [['rules.154']],
		'PHPStan\Rules\Deprecations\FetchingDeprecatedConstRule' => [['rules.155']],
		'PHPStan\Rules\Deprecations\ImplementationOfDeprecatedInterfaceRule' => [['rules.156']],
		'PHPStan\Rules\Deprecations\InheritanceOfDeprecatedClassRule' => [['rules.157']],
		'PHPStan\Rules\Deprecations\InheritanceOfDeprecatedInterfaceRule' => [['rules.158']],
		'PHPStan\Rules\Deprecations\InstantiationOfDeprecatedClassRule' => [['rules.159']],
		'PHPStan\Rules\Deprecations\TypeHintDeprecatedInClassMethodSignatureRule' => [['rules.160']],
		'PHPStan\Rules\Deprecations\TypeHintDeprecatedInClosureSignatureRule' => [['rules.161']],
		'PHPStan\Rules\Deprecations\TypeHintDeprecatedInFunctionSignatureRule' => [['rules.162']],
		'PHPStan\Rules\Deprecations\UsageOfDeprecatedCastRule' => [['rules.163']],
		'PHPStan\Rules\Deprecations\UsageOfDeprecatedTraitRule' => [['rules.164']],
		'PHPStan\Rules\PHPUnit\AssertSameBooleanExpectedRule' => [['rules.165']],
		'PHPStan\Rules\PHPUnit\AssertSameNullExpectedRule' => [['rules.166']],
		'PHPStan\Rules\PHPUnit\AssertSameWithCountRule' => [['rules.167']],
		'PHPStan\Rules\PHPUnit\MockMethodCallRule' => [['rules.168']],
		'PHPStan\Rules\PHPUnit\ShouldCallParentMethodsRule' => [['rules.169']],
		...
		'PHPStan\Reflection\MethodsClassReflectionExtension' => [['081', '091', '093', '095', '097', '0372']],
		...
		'PHPStan\Type\MethodTypeSpecifyingExtension' => [['0245', '0379']],
		...
		'PHPStan\Rules\Deprecations\DeprecatedClassHelper' => [['0373']],
		'PHPStan\DependencyInjection\LazyDeprecatedScopeResolverProvider' => [['0374']],
		'PHPStan\Rules\Deprecations\DeprecatedScopeHelper' => [['0375']],
		'PHPStan\Rules\Deprecations\DeprecatedScopeResolver' => [['0376']],
		'PHPStan\Rules\Deprecations\DefaultDeprecatedScopeResolver' => [['0376']],
		'PHPStan\PhpDoc\TypeNodeResolverExtension' => [['0377']],
		'PHPStan\PhpDoc\TypeNodeResolverAwareExtension' => [['0377']],
		'PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension' => [['0377']],
		'PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension' => [['0378']],
		'PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension' => [['0379']],
		'PHPStan\Type\StaticMethodTypeSpecifyingExtension' => [['0380']],
		'PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension' => [['0380']],
		'PHPStan\Type\PHPUnit\InvocationMockerDynamicReturnTypeExtension' => [['0381']],
		'PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension' => [['0382']],
		'PHPStan\Type\PHPUnit\MockObjectDynamicReturnTypeExtension' => [['0383']],
		'PHPStan\Rules\PHPUnit\CoversHelper' => [['0384']],
		'PHPStan\Rules\PHPUnit\AnnotationHelper' => [['0385']],
		'PHPStan\Rules\PHPUnit\DataProviderHelper' => [['0386']],
		'PHPStan\Rules\PHPUnit\DataProviderHelperFactory' => [['0387']],
		'PHPStan\Rules\PHPUnit\ClassCoversExistsRule' => [['0388']],
		'PHPStan\Rules\PHPUnit\ClassMethodCoversExistsRule' => [['0389']],
		'PHPStan\Rules\PHPUnit\DataProviderDeclarationRule' => [['0390']],
		'PHPStan\Rules\PHPUnit\NoMissingSpaceInClassAnnotationRule' => [['0391']],
		'PHPStan\Rules\PHPUnit\NoMissingSpaceInMethodAnnotationRule' => [['0392']],
	];
	...
	public function createService049(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_5436fa22cc $container)
			{
	...
	public function createService070(): PHPStan\File\FileExcluderFactory
	{
		return new PHPStan\File\FileExcluderFactory(
			$this->getService('071'),
			[],
			['analyseAndScan' => ['C:\www\2024-clients\eloquent-blinds-2024\app\Http\Controllers\Auth'], 'analyse' => []]
		);
	}
	...
	{
		return new PHPStan\Rules\IssetCheck($this->getService('0149'), $this->getService('0150'), false, true, false);
	}
	...
	public function createService0373(): PHPStan\Rules\Deprecations\DeprecatedClassHelper
	{
		return new PHPStan\Rules\Deprecations\DeprecatedClassHelper($this->getService('reflectionProvider'));
	}


	public function createService0374(): PHPStan\DependencyInjection\LazyDeprecatedScopeResolverProvider
	{
		return new PHPStan\DependencyInjection\LazyDeprecatedScopeResolverProvider($this->getService('061'));
	}


	public function createService0375(): PHPStan\Rules\Deprecations\DeprecatedScopeHelper
	{
		return $this->getService('0374')->get();
	}


	public function createService0376(): PHPStan\Rules\Deprecations\DefaultDeprecatedScopeResolver
	{
		return new PHPStan\Rules\Deprecations\DefaultDeprecatedScopeResolver;
	}


	public function createService0377(): PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension
	{
		return new PHPStan\PhpDoc\PHPUnit\MockObjectTypeNodeResolverExtension;
	}


	public function createService0378(): PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertFunctionTypeSpecifyingExtension;
	}


	public function createService0379(): PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertMethodTypeSpecifyingExtension;
	}


	public function createService0380(): PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension
	{
		return new PHPStan\Type\PHPUnit\Assert\AssertStaticMethodTypeSpecifyingExtension;
	}


	public function createService0381(): PHPStan\Type\PHPUnit\InvocationMockerDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPUnit\InvocationMockerDynamicReturnTypeExtension;
	}


	public function createService0382(): PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPUnit\MockBuilderDynamicReturnTypeExtension;
	}


	public function createService0383(): PHPStan\Type\PHPUnit\MockObjectDynamicReturnTypeExtension
	{
		return new PHPStan\Type\PHPUnit\MockObjectDynamicReturnTypeExtension;
	}


	public function createService0384(): PHPStan\Rules\PHPUnit\CoversHelper
	{
		return new PHPStan\Rules\PHPUnit\CoversHelper($this->getService('reflectionProvider'));
	}


	public function createService0385(): PHPStan\Rules\PHPUnit\AnnotationHelper
	{
		return new PHPStan\Rules\PHPUnit\AnnotationHelper;
	}


	public function createService0386(): PHPStan\Rules\PHPUnit\DataProviderHelper
	{
		return $this->getService('0387')->create();
	}


	public function createService0387(): PHPStan\Rules\PHPUnit\DataProviderHelperFactory
	{
		return new PHPStan\Rules\PHPUnit\DataProviderHelperFactory($this->getService('reflectionProvider'), $this->getService('0154'));
	}


	public function createService0388(): PHPStan\Rules\PHPUnit\ClassCoversExistsRule
	{
		return new PHPStan\Rules\PHPUnit\ClassCoversExistsRule($this->getService('0384'), $this->getService('reflectionProvider'));
	}


	public function createService0389(): PHPStan\Rules\PHPUnit\ClassMethodCoversExistsRule
	{
		return new PHPStan\Rules\PHPUnit\ClassMethodCoversExistsRule($this->getService('0384'), $this->getService('0154'));
	}


	public function createService0390(): PHPStan\Rules\PHPUnit\DataProviderDeclarationRule
	{
		return new PHPStan\Rules\PHPUnit\DataProviderDeclarationRule($this->getService('0386'), false, true);
	}


	public function createService0391(): PHPStan\Rules\PHPUnit\NoMissingSpaceInClassAnnotationRule
	{
		return new PHPStan\Rules\PHPUnit\NoMissingSpaceInClassAnnotationRule($this->getService('0385'));
	}


	public function createService0392(): PHPStan\Rules\PHPUnit\NoMissingSpaceInMethodAnnotationRule
	{
		return new PHPStan\Rules\PHPUnit\NoMissingSpaceInMethodAnnotationRule($this->getService('0385'));
	}
	...
	public function createServiceContainer(): Container_5436fa22cc
	{
		return $this;
	}
	...
	public function createServiceRules__149(): PHPStan\Rules\Deprecations\AccessDeprecatedPropertyRule
	{
	...
	public function createServiceRules__150(): PHPStan\Rules\Deprecations\AccessDeprecatedStaticPropertyRule
	{
	...
	public function createServiceRules__151(): PHPStan\Rules\Deprecations\CallToDeprecatedFunctionRule
	{
	...
	public function createServiceRules__152(): PHPStan\Rules\Deprecations\CallToDeprecatedMethodRule
	{
	...
	public function createServiceRules__153(): PHPStan\Rules\Deprecations\CallToDeprecatedStaticMethodRule
	{
	...
	public function createServiceRules__154(): PHPStan\Rules\Deprecations\FetchingClassConstOfDeprecatedClassRule
	{
	...
	public function createServiceRules__155(): PHPStan\Rules\Deprecations\FetchingDeprecatedConstRule
	{
	...
	public function createServiceRules__156(): PHPStan\Rules\Deprecations\ImplementationOfDeprecatedInterfaceRule
	{
	...
	public function createServiceRules__157(): PHPStan\Rules\Deprecations\InheritanceOfDeprecatedClassRule
	{
	...
	public function createServiceRules__158(): PHPStan\Rules\Deprecations\InheritanceOfDeprecatedInterfaceRule
	{
		return new PHPStan\Rules\Deprecations\InheritanceOfDeprecatedInterfaceRule($this->getService('reflectionProvider'));
	}


	public function createServiceRules__159(): PHPStan\Rules\Deprecations\InstantiationOfDeprecatedClassRule
	{
	...
	public function createServiceRules__160(): PHPStan\Rules\Deprecations\TypeHintDeprecatedInClassMethodSignatureRule
	{
	...
	public function createServiceRules__161(): PHPStan\Rules\Deprecations\TypeHintDeprecatedInClosureSignatureRule
	{
	...
	public function createServiceRules__162(): PHPStan\Rules\Deprecations\TypeHintDeprecatedInFunctionSignatureRule
	{
	...
	public function createServiceRules__163(): PHPStan\Rules\Deprecations\UsageOfDeprecatedCastRule
	{
		return new PHPStan\Rules\Deprecations\UsageOfDeprecatedCastRule($this->getService('0375'));
	}


	public function createServiceRules__164(): PHPStan\Rules\Deprecations\UsageOfDeprecatedTraitRule
	{
	...
	public function createServiceRules__165(): PHPStan\Rules\PHPUnit\AssertSameBooleanExpectedRule
	{
		return new PHPStan\Rules\PHPUnit\AssertSameBooleanExpectedRule;
	}


	public function createServiceRules__166(): PHPStan\Rules\PHPUnit\AssertSameNullExpectedRule
	{
		return new PHPStan\Rules\PHPUnit\AssertSameNullExpectedRule;
	}


	public function createServiceRules__167(): PHPStan\Rules\PHPUnit\AssertSameWithCountRule
	{
		return new PHPStan\Rules\PHPUnit\AssertSameWithCountRule;
	}


	public function createServiceRules__168(): PHPStan\Rules\PHPUnit\MockMethodCallRule
	{
		return new PHPStan\Rules\PHPUnit\MockMethodCallRule;
	}


	public function createServiceRules__169(): PHPStan\Rules\PHPUnit\ShouldCallParentMethodsRule
	{
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'excludes_analyse' => [],
			'excludePaths' => [
				'analyseAndScan' => ['C:\www\2024-clients\eloquent-blinds-2024\app\Http\Controllers\Auth'],
				'analyse' => [],
			],
			'level' => 3,
