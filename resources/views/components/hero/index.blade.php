<div class="relative overflow-hidden isolate">
    <div class="wrapper pt-10 pb-4 sm:pb-20 lg:flex z-20 lg:pt-22 2xl:pt-32">
        <div class="mx-auto relative z-20 max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
            ...
            <div class="relative">
                <h1 class="mt-5 heading-1 text-shadow-[5] text-shadow-primary-500/10 dark:text-shadow-black relative">
                    Supplier and installer of Shutters and Blinds.
                </h1>
                <p class="mt-3 text-lg leading-8 text-gray-500 dark:text-gray-300 text-shadow">
                    We offer a wide range of high-quality shutters and blinds at affordable prices. Our shutters and
                    blinds are perfect for any room in the house and will add style and function to your space.
                </p>
