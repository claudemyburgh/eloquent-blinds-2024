...
class Container_a2c7418b6f extends _PHPStan_5473b6701\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService049(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_a2c7418b6f $container)
			{
	...
	public function createServiceContainer(): Container_a2c7418b6f
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'generateBaselineFile' => 'C:\www\2024-clients\eloquent-blinds-2024\phpstan-baseline.neon',
			'usedLevel' => '4',
