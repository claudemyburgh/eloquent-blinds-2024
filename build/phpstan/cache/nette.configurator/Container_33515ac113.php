...
class Container_33515ac113 extends _PHPStan_5473b6701\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService049(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_33515ac113 $container)
			{
	...
	public function createServiceContainer(): Container_33515ac113
	{
		return $this;
	}
