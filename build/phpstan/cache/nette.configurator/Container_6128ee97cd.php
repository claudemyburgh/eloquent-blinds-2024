...
class Container_6128ee97cd extends _PHPStan_5473b6701\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService049(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_6128ee97cd $container)
			{
	...
	public function createServiceContainer(): Container_6128ee97cd
	{
		return $this;
	}
