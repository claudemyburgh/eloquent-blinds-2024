...
const BackendSearch = () => {
  ...
  return (
    <form
      className={`grid grid-cols-12 gap-4 md:gap-x-6 lg:gap-x-8`}
    ...
    >
      ...
      <div className="col-span-12 md:col-span-6 lg:col-span-2">
        ...
        >
          ...
          <option value="greater_or_equal_than">
            Greater or equal than
          </option>
          <option value="less_than">Less than</option>
          <option value="less_or_equal_than">
            Less or equal than
          </option>
        </SelectInput>
      </div>
      <div className="col-span-12 md:col-span-8 flex flex-grow-0">
        <div className={`flex-1`}>
          ...
          <TextInput
            type={`search`}
            id={`value`}
            className={`w-full max-w-full rounded-r-none`}
            value={data.value}
            onChange={handlerInputChange}
          />
        </div>
        <div className={`flex items-end`}>
          <PrimaryButton
            type={`submit`}
            className={`min-h-[42px] rounded-l-none`}
          >
            Search
          </PrimaryButton>
        </div>
