...
class Container_5865f2c08d extends _PHPStan_5473b6701\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService049(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_5865f2c08d $container)
			{
	...
	public function createServiceContainer(): Container_5865f2c08d
	{
		return $this;
	}
